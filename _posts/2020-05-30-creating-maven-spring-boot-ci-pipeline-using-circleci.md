...
show_ads: false
---
It is very important to automate the process of running the tests before deploying your code. [CircleCI](https://circleci.com/) is a platform which help developers to create [CI](https://en.wikipedia.org/wiki/Continuous_integration) pipelines for your project.
